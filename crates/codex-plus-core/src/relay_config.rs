...
pub fn apply_relay_files_to_home_with_context(
    ...
    with_live_files_transaction(home, || {
        let selected_common =
            filter_common_config_for_selection(common_config_contents, selection)?;
...
pub fn apply_pure_api_config_to_home_with_protocol(
    ...
    with_live_files_transaction(home, || {
        apply_pure_api_config_to_home_with_protocol_locked(
            home,
            base_url,
            bearer_token,
            protocol,
...
fn apply_pure_api_config_to_home_with_protocol_locked(
    home: &Path,
    base_url: &str,
    bearer_token: &str,
    protocol: RelayProtocol,
